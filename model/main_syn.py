...
def main():
    ...
    with open(os.path.join("/autodl-fs/data/task_diversity_BFL-master/data/synthetic", args.dataset, 'param.json'), 'r') as f:
        param = json.load(f)
    # fed task
    ...
    torch.save(plot, os.path.join("/autodl-fs/data/task_diversity_BFL-master/data/synthetic/", args.dataset, f"simulation.pth"))
    ...
    plot = eval_model(GPs, super_params, args)
    logging.info(f"Aggregate super parameters: {super_params}")
    torch.save(plot, os.path.join("/autodl-fs/data/task_diversity_BFL-master/data/synthetic/", args.dataset, f"simulationreg.pth"))
    ...
    plot = eval_model(GPs, super_params, args)
    logging.info(f"Aggregate super parameters: {super_params}")
    torch.save(plot, os.path.join("/autodl-fs/data/task_diversity_BFL-master/data/synthetic/", args.dataset, f"simulationcla.pth"))
